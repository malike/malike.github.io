...
![aws pipeline ui cluster]({{ site.github.url }}/assets/img/aws-pipeline-ui.png)
...
![aws pipeline ci cd cluster]({{ site.github.url }}/assets/img/aws-pipeline-ci-cd.png)
...
![ecr new images ]({{ site.github.url }}/assets/img/ecr-new-images.png)
