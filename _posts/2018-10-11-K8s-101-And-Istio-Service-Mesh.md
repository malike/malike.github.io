...
layout: post
author: "malike_st"
section: devops,distributed,sre
projectname: Learning Kubernetes and Istio Service Mesh
projectdescription: A project that uses Github, Travis CI, Docker, Dockerhub, Kubernetes and Istio Service Mesh to deploy Go and Java microservices with an HTML frontend using both the Blue/Green deployment as well as Canary Deployment. 
projecturl: https://github.com/malike/sidecar-ruby-on-rails-java
...
![https://kubernetes.io/docs/concepts/architecture/cloud-controller/]({{ site.github.url }}/assets/img/post-ccm-arch.png)
...
![pods-success]({{ site.github.url }}/assets/img/pods-success.png)

![pods-success-dashboard.png]({{ site.github.url }}/assets/img/pods-success-dashboard.png)
...
![configmap-success]({{ site.github.url }}/assets/img/configmap-success.png)
...
![lb-success-dashboard.png]({{ site.github.url }}/assets/img/lb-success-dashboard.png)
...
![lb-instance-one]({{ site.github.url }}/assets/img/lb-instance-one.png)

###### <center>instance one</center>

![lb-instance-two]({{ site.github.url }}/assets/img/lb-instance-two.png)
...
![lb-no-pods]({{ site.github.url }}/assets/img/lb-no-pods.png)
...
![ramped-deployment-progress]({{ site.github.url }}/assets/img/ramped-deployment-progress.png)
...
![ramped-deployment-progress-kubetctl]({{ site.github.url }}/assets/img/ramped-deployment-progress-kubetctl.png)
...
![scaling-1]({{ site.github.url }}/assets/img/scaling-1.png)

##### ii. New pod started

![scaling-2]({{ site.github.url }}/assets/img/scaling-2.png)

##### iii. New pod running

![scaling-3]({{ site.github.url }}/assets/img/scaling-3.png)
...
![scaling-4]({{ site.github.url }}/assets/img/scaling-4.png)
...
![update-rollout-1.png]({{ site.github.url }}/assets/img/update-rollout-1.png)

##### ii.  Adds new updated pod as secondary ,because "maxSurge" is 1 in deployment config

![update-rollout-2.png]({{ site.github.url }}/assets/img/update-rollout-2.png)

##### iii.  Removed old versions and voila we have our cluster

![update-rollout-3.png]({{ site.github.url }}/assets/img/update-rollout-3.png)
...
![update-rollout-4.png]({{ site.github.url }}/assets/img/update-rollout-4.png)
...
![pods-with-envoy]({{ site.github.url }}/assets/img/pods-with-envoy.png)
...
![canary-mobile-route]({{ site.github.url }}/assets/img/canary-mobile-route.png)

###### <center>1. canary mobile route</center>

![canary-web-route]({{ site.github.url }}/assets/img/canary-web-route.png)
...
![istio-prometheus]({{ site.github.url }}/assets/img/istio-prometheus.png)
...
![istio-grafana]({{ site.github.url }}/assets/img/istio-grafana.png)
...
![istio-jaeger]({{ site.github.url }}/assets/img/istio-jaeger.png)
