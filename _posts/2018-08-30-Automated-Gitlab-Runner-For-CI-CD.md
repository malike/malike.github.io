...
layout: post
comments: true
title: Automated Gitlab CI/CD Pipeline for a Maven Project
author: "malike_st"
section: devops,sre
tags: [devops,ci,cd,gitlab]
image: dilbert_devops_monkey.jpg
---
...
`gitlab-ci`:
![gitlab pipeline]({{ site.github.url }}/assets/img/pipeline-ci-cd-token.png) 
...
![gitlab pipeline]({{ site.github.url }}/assets/img/pipeline-ci-cd-config.png) 
...
![gitlab pipeline]({{ site.github.url }}/assets/img/pipeline-ci-cd.png) 
