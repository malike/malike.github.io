...
2015 was kind of great. But also a dissapointing one that once again confirmed the ***Babel Theory***. 
...
Google Translate for that. But the **app store**. *Everyone* is focused on putting something on the AppStore,PlayStore,Windows shop or some other store. Funny thing is most of them can all be categorised under *Uber for this* or *Messaging for that*. 

With this huge number doing this everyday no wonder we call a two-wheel scooter a hoverboard.
