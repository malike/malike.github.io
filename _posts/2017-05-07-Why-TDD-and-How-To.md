...
![_config.yml]({{ site.github.url }}/assets/img/first_red.png) 
...
![_config.yml]({{ site.github.url }}/assets/img/first_green.png).
...
![_config.yml]({{ site.github.url }}/assets/img/all_green.png).
